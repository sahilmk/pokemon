...
import { Buttoncomp } from "../../stories/components";
        ...
        {pokemonData && (
          <>
            ...
            <div className={style.middleData}>
              ...
              <div className={style.label}>List of abilities:</div>
              <div className={style.ability}>
                {pokemonData.abilities.map(
                  (pability: EbilitiesType, index: number) => {
                    return (
                      <p key={index}>
                        {index + 1}.{pability.ability.name}
                      </p>
                    );
                  }
                )}
